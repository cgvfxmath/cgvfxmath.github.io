...
<p style="text-align: center;">$\mathbf{u} = u_1 \mathbf{v}_1 + u_2 \mathbf{v}_2 + \cdots + u_n \mathbf{v}_m$</p>
...
$= (u_1, u_2, \cdots, u_n) \cdot (u_1 \lambda_1, u_2 \lambda_2, \cdots, u_m \lambda_m)$
