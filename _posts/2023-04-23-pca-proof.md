...
$\frac{1}{m} \sum_{i=1}^{m} {q_i}^{2}$ $= \frac{1}{m} \sum_{i=1}^{m} \left( \mathbf{p}_{i}^\text{T} \mathbf{u} \right)^2$ $= \frac{1}{m} \sum_{i=1}^{m} (\mathbf{p}_i^\text{T} \mathbf{u})^\text{T} (\mathbf{p}_i^\text{T} \mathbf{u})$ $= \frac{1}{m} \sum_{i=1}^{m} (\mathbf{u}^\text{T} \mathbf{p}_i) (\mathbf{p}_i^\text{T} \mathbf{u})$

$= \mathbf{u}^\text{T} \left( \frac{1}{m} \sum_{i=1}^{m} \mathbf{p}_i \mathbf{p}_i^\text{T} \right) \mathbf{u}$ $= \mathbf{u}^\text{T} \mathbf{C} \mathbf{u}$
