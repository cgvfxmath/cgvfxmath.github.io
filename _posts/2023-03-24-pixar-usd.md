...
이러한 문제를 해결하려면 set_usd_env.bat와 함께 usdview.cmd를 사용하는 대신 %USD_INSTALL_DIR%\scripts에 있는 usdview.bat 또는 usdview_gui.bat를 사용해야 합니다. 이 파일들을 열어보면 내부적으로 set_usd_env.bat를 실행하여 필요한 환경변수를 설정한 후에 usdview.cmd를 실행하는 것을 확인할 수 있습니다.
