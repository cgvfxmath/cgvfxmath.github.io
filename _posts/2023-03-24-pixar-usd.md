...
<center><img src="https://cgvfxmath.github.io/assets/img/pixar_usd_install_path.png" width="70%"></center>
<br/>
...
다음은 설정해야 하는 환경변수가 무엇인기 알기 위해서 set_usd_env.bat와  set_usd_python_env.bat를 하나로 합치고 간략화한 내용입니다.
...
nVIDIA에서 바이너리 형태로 배포한 USD 패키지는 자체적으로 python.exe를 가지고 있습니다.
* %USD_INSTALL_DIR%\python\python.exe
...
하지만 원래 사용하던 python.exe를 사용하고 싶다면 
...
하지만 이러한 방식은 명령 프롬프트(Command Prompt)를 열 때 마다 이 배치파일을 실행해야 하는 문제를 가지고 있습니다.
