...
여기서 $xy$항은 편의상 생략하겠습니다. 즉, $e=0$으로 가정하겠습니다. ($xy$항은 축에 정렬되어 있는 이차곡선을 회전시킨 결과로 나타나는 행이므로 이차곡선의 본질적과는 직접적으로 관련이 없기 때문입니다.)

과 직접적인 관련이 없기 때문에 생략하겠습니다. 즉, $e=0$으로 가정합니다.
