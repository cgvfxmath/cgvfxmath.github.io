...
<p style="text-align: center;">$\underset{{a,b}}{\text{argmin}} \left \| y_i - (ax_i + b) \right \| \;\;\; \Longleftrightarrow \;\;\; a = \overline{y} - b \overline{x}, \;\;\; b = \frac{\sum(x_i - \overline{x})(y_i - \overline{y})}{\sum(x_i - \overline{x})^2}$</p>
