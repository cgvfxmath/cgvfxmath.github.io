...
* $(a+b)^{n}$의 $k+1$번째 항: $_{n} C _{k} a^{n-k} b^{k}$
* $(a+b)^{n-1}$의 $k$번째 항: $_{n-1} C _{k-1} a^{n-k} b^{k-1}$ (위의 $_{n} C _{k} a^{n-k} b^{k}$항보다 $b$의 차수가 하나 작음)
* $(a+b)^{n-1}$의 $k+1$번째 항: $_{n-1} C _{k} a^{n-k-1} b^{k}$ (위의 $_{n} C _{k} a^{n-k} b^{k}$항보다 $a$의 차수가 하나 작음)
